...
// ✍️ تم تصحيح طريقة كتابة النص باستخدام Template Literals (```)
const MESSAGE_TEXT = `حبيبي ونور عيني وحياتي كلها.. ✨❤️🙈
من يوم ما دخلت حياتي وأنت خليت كل حاجة فيها لها طعم تاني خالص.. بجد أنت حليت دنيتي وخليتني أحب حياتي طول ما أنت فيها ومعايا.. 🥰🥺💖 أنت مش مجرد شخص في حياتي، أنت حياتي كلها وعوضي الحلو عن أي حاجة صعبة شفتها.. 🙈❤️✨
عارف؟ مهما يحصل بينا أو نختلف أو نتخانق، عوزاك دايماً تفتكر وتعرف إن ملناش غير بعض.. 🫂❤️ الخناقات دي شوية زعل بسيط وبيعدي، المهم إننا ما نسيبش إيد بعض أبداً ونعدي أي حاجة سوا ونفضل متمسكين ببعض للآخر.. 🥹❤️🔒
أوعى في يوم تسيبني أو تبعد عني.. لأن بجد أنا مش هعرف أعيش من غيرك ولا أتخيل حياتي ثانية واحدة بعيد عنك.. 🥺💔😭 أنا مش عاوزة من الدنيا كلها غيرك أنت، ومفيش أي حد في العالم كله هيعرف يوصل لمكانتك في قلبي ولا ياخد مكانك.. أنت وبس اللي في قلبي وعقلي وحياتي كلها يا روح قلبي.. 🙈❤️❤️❤️
بحبك أوي أوي يا كل حاجة ليا في الدنيا، وتفضل معايا العمر كله وما يفرقناش غير الموت يا رب.. 🤲🏻❤️✨🫂`;
...
const Hero = ({ onNext }) => {
  ...
  useEffect(() => {
    let currentIndex = 0;
    setDisplayedText(""); // إعادة ضبط النص عند تغيير المتغير
    ...
    }, 45); // سرعة كتابة الحروف (بالميللي ثانية)
