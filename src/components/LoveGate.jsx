...
const LoveGate = ({ onUnlock }) => {
    ...
    const correctPassword = "mohamed"; // كلمة المرور
    ...
    return (
        <div className="relative min-h-screen w-full bg-[#52000d] flex flex-col items-center justify-between overflow-hidden font-sans select-none py-8 px-4 text-white dir-rtl">
            ...
            >
                <div className="bg-black/30 backdrop-blur-md border border-white/10 rounded-2xl py-2 px-4 shadow-lg flex justify-center items-center text-xs">
                    <div>
                        <p className="text-pink-300 font-bold">بداية حكايتنا 🌹</p>
                        <p className="text-gray-200 font-mono">10 / 08 / 2021</p>
                    </div>
                </div>
